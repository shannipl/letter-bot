...
// SelectSpotsByNameLike provides a mock function for the type MockSpotRepository
func (_mock *MockSpotRepository) SelectSpotsByNameLike(ctx context.Context, namePattern string) ([]*spot.Spot, error) {
	ret := _mock.Called(ctx, namePattern)

	if len(ret) == 0 {
		panic("no return value specified for SelectSpotsByNameLike")
	}
...
// MockSpotRepository_SelectSpotsByNameLike_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SelectSpotsByNameLike'
type MockSpotRepository_SelectSpotsByNameLike_Call struct {
	*mock.Call
}

// SelectSpotsByNameLike is a helper method to define mock.On call
//   - ctx context.Context
//   - namePattern string
func (_e *MockSpotRepository_Expecter) SelectSpotsByNameLike(ctx interface{}, namePattern interface{}) *MockSpotRepository_SelectSpotsByNameLike_Call {
	return &MockSpotRepository_SelectSpotsByNameLike_Call{Call: _e.mock.On("SelectSpotsByNameLike", ctx, namePattern)}
}

func (_c *MockSpotRepository_SelectSpotsByNameLike_Call) Run(run func(ctx context.Context, namePattern string)) *MockSpotRepository_SelectSpotsByNameLike_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockSpotRepository_SelectSpotsByNameLike_Call) Return(spots []*spot.Spot, err error) *MockSpotRepository_SelectSpotsByNameLike_Call {
	_c.Call.Return(spots, err)
	return _c
}

func (_c *MockSpotRepository_SelectSpotsByNameLike_Call) RunAndReturn(run func(ctx context.Context, namePattern string) ([]*spot.Spot, error)) *MockSpotRepository_SelectSpotsByNameLike_Call {
	_c.Call.Return(run)
	return _c
}
