...
func (repo *SpotRepository) SelectSpotsByNameLike(ctx context.Context, namePattern string) ([]*spot.Spot, error) {
	res, err := repo.q.SelectSpotsByNameLike(ctx, namePattern)
	if err != nil {
		return []*spot.Spot{}, err
	}
